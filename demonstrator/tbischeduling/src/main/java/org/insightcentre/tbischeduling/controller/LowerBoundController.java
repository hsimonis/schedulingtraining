...
public class LowerBoundController extends Table3Controller {
	...
	@FXML
	private TableColumn<LowerBound, String> name;

	@FXML
	private TableColumn<LowerBound, Integer> value;

	@FXML
	private TableColumn<LowerBound, String> description;
	...
	public TableView<LowerBound> getTable() {
		return table;
	}
	...
	public void filter(String attribute, String comparison, String text) {
		table.setItems(mainApp.getLowerBoundData());
		try {
			ObservableList<LowerBound> filteredItems = FXCollections.observableArrayList();
			for (LowerBound item : table.getItems()) {
