...
public class SolverRunController extends Table3Controller {
	...
	@FXML
	private TableColumn<SolverRun, String> name;

	@FXML
	private TableColumn<SolverRun, String> label;
	...
	@FXML
	private TableColumn<SolverRun, Integer> nrThreads;

	@FXML
	private TableColumn<SolverRun, Integer> seed;
	...
	@FXML
	private TableColumn<SolverRun, Double> time;
	...
	public TableView<SolverRun> getTable() {
		return table;
	}
	...
	public void filter(String attribute, String comparison, String text) {
		table.setItems(mainApp.getSolverRunData());
		try {
			ObservableList<SolverRun> filteredItems = FXCollections.observableArrayList();
			for (SolverRun item : table.getItems()) {
	...
	class EnforceReleaseDateCallback implements Callback<TableColumn.CellDataFeatures<SolverRun, Boolean>, ObservableValue<Boolean>> {
		@Override
	...
	class EnforceDueDateCallback implements Callback<TableColumn.CellDataFeatures<SolverRun, Boolean>, ObservableValue<Boolean>> {
		@Override
		public ObservableValue<Boolean> call(TableColumn.CellDataFeatures<SolverRun, Boolean> cellData) {
	...
	class AddSameOrderCallback implements Callback<TableColumn.CellDataFeatures<SolverRun, Boolean>, ObservableValue<Boolean>> {
		@Override
		public ObservableValue<Boolean> call(TableColumn.CellDataFeatures<SolverRun, Boolean> cellData) {
