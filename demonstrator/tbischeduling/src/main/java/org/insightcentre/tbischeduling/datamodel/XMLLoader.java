        ...
        public void startElement(String uri,
            ...
            if (qname.equals("body")) {
                ...
                store(id, new Job(base,
                        id,
                        getString("name", attributes, "dummy"),
                        getBoolean("noOverlap",attributes,false),
                        getInteger("nr",attributes,0),
                        null,
                        null
                        ));
                ...
                store(id, new SolutionSummary(base,
                        ...
                        getInteger("instanceNr",attributes,0),
                        getInteger("makespan",attributes,0),
                ...
                store(id, new SolverProperty(base,
                        id,
                        getString("name", attributes, "dummy"),
                        getBoolean("addBlocking",attributes,false),
                        getBoolean("addNoWait",attributes,false),
                        ...
                        getBoolean("enforceTransportTime",attributes,false),
                        ...
                        getBoolean("relaxSequence",attributes,false),
