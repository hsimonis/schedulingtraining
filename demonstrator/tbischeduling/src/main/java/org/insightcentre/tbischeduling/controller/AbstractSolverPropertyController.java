...
public class AbstractSolverPropertyController extends Table3Controller {
	...
	@FXML
	private TableColumn<AbstractSolverProperty, String> name;

	@FXML
	private TableColumn<AbstractSolverProperty, String> label;

	@FXML
	private TableColumn<AbstractSolverProperty, String> description;

	@FXML
	private TableColumn<AbstractSolverProperty, DateTime> startDateTime;

	@FXML
	private TableColumn<AbstractSolverProperty, Boolean> enforceReleaseDate;

	@FXML
	private TableColumn<AbstractSolverProperty, Boolean> enforceDueDate;

	@FXML
	private TableColumn<AbstractSolverProperty, Boolean> enforceCumulative;

	@FXML
	private TableColumn<AbstractSolverProperty, Boolean> enforceWip;
	...
	@FXML
	private TableColumn<AbstractSolverProperty, Boolean> enforceTransportTime;

	@FXML
	private TableColumn<AbstractSolverProperty, Boolean> relaxSequence;

	@FXML
	private TableColumn<AbstractSolverProperty, Boolean> addSameOrder;

	@FXML
	private TableColumn<AbstractSolverProperty, Boolean> addNoWait;

	@FXML
	private TableColumn<AbstractSolverProperty, Boolean> addBlocking;

	@FXML
	private TableColumn<AbstractSolverProperty, ModelType> modelType;

	@FXML
	private TableColumn<AbstractSolverProperty, SolverBackend> solverBackend;

	@FXML
	private TableColumn<AbstractSolverProperty, ObjectiveType> objectiveType;

	@FXML
	private TableColumn<AbstractSolverProperty, Integer> weightMakespan;

	@FXML
	private TableColumn<AbstractSolverProperty, Integer> weightFlowtime;

	@FXML
	private TableColumn<AbstractSolverProperty, Integer> weightLateness;

	@FXML
	private TableColumn<AbstractSolverProperty, Integer> weightEarliness;

	@FXML
	private TableColumn<AbstractSolverProperty, Integer> timeout;

	@FXML
	private TableColumn<AbstractSolverProperty, Integer> nrThreads;

	@FXML
	private TableColumn<AbstractSolverProperty, Integer> seed;

	@FXML
	private TableColumn<AbstractSolverProperty, Boolean> removeSolution;

	@FXML
	private TableColumn<AbstractSolverProperty, Boolean> produceReport;

	@FXML
	private TableColumn<AbstractSolverProperty, Boolean> producePDF;
	...
	public void setMainApp(AbstractJfxMainWindow app) {
		...
		table.setItems(mainApp.getAbstractSolverPropertyData());
	...
	public TableView<AbstractSolverProperty> getTable() {
		return table;
	}
	...
	public void filter(String attribute, String comparison, String text) {
		table.setItems(mainApp.getAbstractSolverPropertyData());
		try {
			ObservableList<AbstractSolverProperty> filteredItems = FXCollections.observableArrayList();
			for (AbstractSolverProperty item : table.getItems()) {
