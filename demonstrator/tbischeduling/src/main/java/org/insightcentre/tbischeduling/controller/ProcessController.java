...
public class ProcessController extends Table3Controller {
	...
	public void setMainApp(AbstractJfxMainWindow app) {
		...
		table.setItems(mainApp.getProcessData());
	}

	public TableView<Process> getTable() {
		return table;
	}
	...
	public void filter(String attribute, String comparison, String text) {
		table.setItems(mainApp.getProcessData());
		try {
			ObservableList<Process> filteredItems = FXCollections.observableArrayList();
			for (Process item : table.getItems()) {
