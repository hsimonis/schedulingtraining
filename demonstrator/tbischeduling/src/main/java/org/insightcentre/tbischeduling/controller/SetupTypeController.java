...
public class SetupTypeController extends Table3Controller {
	...
	@FXML
	private TableColumn<SetupType, String> name;

	@FXML
	private TableColumn<SetupType, Setup> setup;

	@FXML
	private TableColumn<SetupType, Integer> nr;

	@FXML
	private TableColumn<SetupType, String> processStep;
	...
	public void setMainApp(AbstractJfxMainWindow app) {
		...
		table.setItems(mainApp.getSetupTypeData());
	...
	public TableView<SetupType> getTable() {
		return table;
	}
	...
	private void initialize() {
		...
		processStep.setCellValueFactory(cellData -> new SimpleStringProperty(convert(cellData.getValue().getProcessStep())));
		initialize(choices);
	}
	...
	public void filter(String attribute, String comparison, String text) {
		table.setItems(mainApp.getSetupTypeData());
		try {
			ObservableList<SetupType> filteredItems = FXCollections.observableArrayList();
			for (SetupType item : table.getItems()) {
