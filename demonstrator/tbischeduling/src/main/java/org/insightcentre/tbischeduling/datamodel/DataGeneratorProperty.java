...
public  class DataGeneratorProperty extends AbstractDataGeneratorProperty{
/**
 *  No-arg constructor for use in TableView
 *
*/

    public DataGeneratorProperty(){
        super();
    }
...
*/
    ...
    public DataGeneratorProperty(ApplicationDataset applicationDataset){
        super(applicationDataset);
        applicationDataset.addDataGeneratorProperty(this);
    }
...
*/
    ...
    public DataGeneratorProperty(DataGeneratorProperty other){
...
*/
    ...
    public Boolean remove(){
        getApplicationDataset().cascadeScenarioDataGeneratorProperty(this);
        return getApplicationDataset().removeDataGeneratorProperty(this) && getApplicationDataset().removeAbstractDataGeneratorProperty(this) && getApplicationDataset().removeApplicationObject(this);
    }
...
*/
     ...
     public void toXML(PrintWriter out){
         out.println("<dataGeneratorProperty "+ " applicationDataset=\""+toXMLApplicationDataset()+"\""+
            " id=\""+toXMLId()+"\""+
            " name=\""+toXMLName()+"\""+
 ...
 * @param a DataGeneratorProperty item we are looking for
 * @param bList List<DataGeneratorProperty> list of items in which we are searching
 * @return DataGeneratorProperty entry of list b which is applicationSame() to a
*/

    public static DataGeneratorProperty find(DataGeneratorProperty a, List<DataGeneratorProperty> bList){
 ...
 * @param name DataGeneratorProperty name of the object we are looking for
 * @return DataGeneratorProperty entry of the dataset with the given name; otherwise null
*/

    public static DataGeneratorProperty findByName(ApplicationDataset base, String name){
        for(DataGeneratorProperty a:base.getListDataGeneratorProperty()) {
 ...
 * @param base  dataset in which we are searching
 * @param name DataGeneratorProperty name of the object we are looking for
 * @return DataGeneratorProperty entry of the dataset with the given name
*/

    public static DataGeneratorProperty findOrCreate(ApplicationDataset base, String name){
 ...
 * @param base dataset in which we are searching
 * @return DataGeneratorProperty first entry in the dataset of this type; null if that does not exists
*/

    public static DataGeneratorProperty findFirst(ApplicationDataset base){
        if (base.getListDataGeneratorProperty().isEmpty()) {
            return null;
        }
        return base.getListDataGeneratorProperty().get(0);
    }

/**
 * find some entry entry in the dataset of that type
 * @param base dataset in which we are searching
 * @return DataGeneratorProperty some entry in the dataset of this type; null if that does not exists
*/

    public static DataGeneratorProperty findAny(ApplicationDataset base){
        int size=base.getListDataGeneratorProperty().size();
        if (size > 0) {
             return base.getListDataGeneratorProperty().get(new Random().nextInt(size));
        }
        return null;
    }
 ...
 * @param base dataset in which we are searching
 * @return DataGeneratorProperty last entry in the dataset of this type; null if that does not exists
*/

    public static DataGeneratorProperty findLast(ApplicationDataset base){
        int size=base.getListDataGeneratorProperty().size();
        if (size > 0) {
             return base.getListDataGeneratorProperty().get(size-1);
        }
        return null;
    }
 ...
 * @param b DataGeneratorProperty compare this to that object
 * @return Boolean true if the objects match the same criteria
*/

    public Boolean applicationSame(DataGeneratorProperty b){
...
*/
    ...
    public Boolean applicationEqual(DataGeneratorProperty b){
...
*/
    ...
    public void check(){
        if (getApplicationDataset() == null){
         new ApplicationWarning(getApplicationDataset(),ApplicationDataset.getIdNr(),toColumnString(),"applicationDataset","DataGeneratorProperty",(getApplicationDataset()==null?"null":getApplicationDataset().toString()),"",WarningType.NOTNULL);
        }
    }

    static void dummy(ApplicationDataset base){
// no dummy information for class DataGeneratorProperty
    }
