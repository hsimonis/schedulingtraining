...
public class InputErrorController extends Table3Controller {
	...
	@FXML
	private TableColumn<InputError, String> name;

	@FXML
	private TableColumn<InputError, String> classDesc;

	@FXML
	private TableColumn<InputError, String> item;

	@FXML
	private TableColumn<InputError, String> field;

	@FXML
	private TableColumn<InputError, String> value;

	@FXML
	private TableColumn<InputError, String> description;

	@FXML
	private TableColumn<InputError, Severity> severity;
	...
	public TableView<InputError> getTable() {
		return table;
	}
	...
	public void filter(String attribute, String comparison, String text) {
		table.setItems(mainApp.getInputErrorData());
		try {
			ObservableList<InputError> filteredItems = FXCollections.observableArrayList();
			for (InputError item : table.getItems()) {
