...
public class ReadSALBPAlternativeFile {
    public ReadSALBPAlternativeFile(Scenario base, File file){
        ...
        try {
            ...
            DisjunctiveResource disj = new DisjunctiveResource(base);
            disj.setName("D");
            ...
            for(int i=0;i<nrTasks;i++){
                ...
                rn.setName("RN"+nr);
                rn.setDisjunctiveResource(disj);
...
//                info("from "+from+" to "+to);
                ...
                p.setBefore(before);
                p.setAfter(after);
                p.setSequenceType(EndBeforeStart);
                p.setOffset(0);
            ...
            for(int d=0;d<base.getHorizon()/cycleTime;d++){
                ...
                down.setName("D"+d);
                int start = cycleTime+d*(cycleTime+1);
                down.setStart(start);
                down.setDuration(1);
                down.setEnd(start+1);
                down.setDisjunctiveResource(disj);
