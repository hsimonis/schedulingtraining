...
public class ResourceActivityController extends Table3Controller {
	...
	@FXML
	private TableColumn<ResourceActivity, String> name;

	@FXML
	private TableColumn<ResourceActivity, DisjunctiveResource> disjunctiveResource;

	@FXML
	private TableColumn<ResourceActivity, Integer> duration;

	@FXML
	private TableColumn<ResourceActivity, Integer> start;

	@FXML
	private TableColumn<ResourceActivity, Integer> end;

	@FXML
	private TableColumn<ResourceActivity, DateTime> startDate;

	@FXML
	private TableColumn<ResourceActivity, DateTime> endDate;
	...
	public void setMainApp(AbstractJfxMainWindow app) {
		...
		table.setItems(mainApp.getResourceActivityData());
	...
	public TableView<ResourceActivity> getTable() {
		return table;
	}
	...
	public void filter(String attribute, String comparison, String text) {
		table.setItems(mainApp.getResourceActivityData());
		try {
			ObservableList<ResourceActivity> filteredItems = FXCollections.observableArrayList();
			for (ResourceActivity item : table.getItems()) {
