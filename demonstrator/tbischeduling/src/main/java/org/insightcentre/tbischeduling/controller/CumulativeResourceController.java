...
public class CumulativeResourceController extends Table3Controller {
	...
	@FXML
	private TableColumn<CumulativeResource, String> name;
	...
	public TableView<CumulativeResource> getTable() {
		return table;
	}
	...
	public void filter(String attribute, String comparison, String text) {
		table.setItems(mainApp.getCumulativeResourceData());
		try {
			ObservableList<CumulativeResource> filteredItems = FXCollections.observableArrayList();
			for (CumulativeResource item : table.getItems()) {
