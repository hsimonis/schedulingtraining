...
public class AbstractDataGeneratorPropertyController extends Table3Controller {
	@FXML
	private TableView<AbstractDataGeneratorProperty> table;

	@FXML
	private TableColumn<AbstractDataGeneratorProperty, String> name;

	@FXML
	private TableColumn<AbstractDataGeneratorProperty, String> label;

	@FXML
	private TableColumn<AbstractDataGeneratorProperty, DateTime> startDateTime;

	@FXML
	private TableColumn<AbstractDataGeneratorProperty, ResourceModel> resourceModel;

	@FXML
	private TableColumn<AbstractDataGeneratorProperty, Integer> nrProducts;

	@FXML
	private TableColumn<AbstractDataGeneratorProperty, Integer> minStages;

	@FXML
	private TableColumn<AbstractDataGeneratorProperty, Integer> maxStages;

	@FXML
	private TableColumn<AbstractDataGeneratorProperty, Integer> nrDisjunctiveResources;

	@FXML
	private TableColumn<AbstractDataGeneratorProperty, Double> resourceProbability;

	@FXML
	private TableColumn<AbstractDataGeneratorProperty, DurationModel> durationModel;

	@FXML
	private TableColumn<AbstractDataGeneratorProperty, Integer> minDuration;

	@FXML
	private TableColumn<AbstractDataGeneratorProperty, Integer> maxDuration;

	@FXML
	private TableColumn<AbstractDataGeneratorProperty, Integer> durationFixedFactor;

	@FXML
	private TableColumn<AbstractDataGeneratorProperty, Integer> nrCumulativeResources;

	@FXML
	private TableColumn<AbstractDataGeneratorProperty, Integer> minCumulDemand;

	@FXML
	private TableColumn<AbstractDataGeneratorProperty, Integer> maxCumulDemand;

	@FXML
	private TableColumn<AbstractDataGeneratorProperty, Integer> profilePieces;

	@FXML
	private TableColumn<AbstractDataGeneratorProperty, Integer> minCumulCapacity;

	@FXML
	private TableColumn<AbstractDataGeneratorProperty, Integer> maxCumulCapacity;

	@FXML
	private TableColumn<AbstractDataGeneratorProperty, Integer> nrOrders;

	@FXML
	private TableColumn<AbstractDataGeneratorProperty, Integer> minQty;

	@FXML
	private TableColumn<AbstractDataGeneratorProperty, Integer> maxQty;

	@FXML
	private TableColumn<AbstractDataGeneratorProperty, Double> wipProbability;

	@FXML
	private TableColumn<AbstractDataGeneratorProperty, Integer> minWip;

	@FXML
	private TableColumn<AbstractDataGeneratorProperty, Integer> maxWip;

	@FXML
	private TableColumn<AbstractDataGeneratorProperty, Double> downtimeProbability;

	@FXML
	private TableColumn<AbstractDataGeneratorProperty, Integer> minDowntime;

	@FXML
	private TableColumn<AbstractDataGeneratorProperty, Integer> maxDowntime;

	@FXML
	private TableColumn<AbstractDataGeneratorProperty, Integer> earliestDue;

	@FXML
	private TableColumn<AbstractDataGeneratorProperty, Integer> horizonDays;

	@FXML
	private TableColumn<AbstractDataGeneratorProperty, Integer> timeResolution;

	@FXML
	private TableColumn<AbstractDataGeneratorProperty, Integer> seed;
	...
	public TableView<AbstractDataGeneratorProperty> getTable() {
		return table;
	}
	...
	public void filter(String attribute, String comparison, String text) {
		table.setItems(mainApp.getAbstractDataGeneratorPropertyData());
		try {
			ObservableList<AbstractDataGeneratorProperty> filteredItems = FXCollections.observableArrayList();
			for (AbstractDataGeneratorProperty item : table.getItems()) {
