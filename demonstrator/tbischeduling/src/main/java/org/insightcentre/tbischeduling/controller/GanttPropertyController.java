...
public class GanttPropertyController extends Table3Controller {
	...
	@FXML
	private TableColumn<GanttProperty, String> name;

	@FXML
	private TableColumn<GanttProperty, LineChoice> showLate;

	@FXML
	private TableColumn<GanttProperty, LineChoice> showEarly;

	@FXML
	private TableColumn<GanttProperty, LineChoice> showRelease;

	@FXML
	private TableColumn<GanttProperty, LineChoice> showWait;

	@FXML
	private TableColumn<GanttProperty, LineChoice> showSetup;

	@FXML
	private TableColumn<GanttProperty, LineChoice> showIdle;

	@FXML
	private TableColumn<GanttProperty, DatesDisplay> datesDisplay;
	...
	public TableView<GanttProperty> getTable() {
		return table;
	}
	...
	public void filter(String attribute, String comparison, String text) {
		table.setItems(mainApp.getGanttPropertyData());
		try {
			ObservableList<GanttProperty> filteredItems = FXCollections.observableArrayList();
			for (GanttProperty item : table.getItems()) {
