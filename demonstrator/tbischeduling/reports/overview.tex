...
\section{Results for Chuffed}

\input{resultsossChuffed}

\section{Results for Cplex}

\input{resultsossCplex}

\section{Results for MiniZinc CPSat}

\input{resultsossMCPSat}
...
\input{resultsjssChuffed}

\section{Results for Cplex}

\input{resultsjssCplex}

\section{Results for MiniZinc CPSat}

\input{resultsjssMCPSat}
...
\input{resultsfssChuffed}

\section{Results for Cplex}

\input{resultsfssCplex}

\section{Results for MiniZinc CPSat}

\input{resultsfssMCPSat}
...
\clearpage
\chapter{Result Comparison for Taillard FSS}

\input{fssresultsummary}
\clearpage

\input{fssresultcompare}

\clearpage
\chapter{Result Comparison for Taillard JSS}

\input{jssresultsummary}
\clearpage

\input{jssresultcompare}

\clearpage
\chapter{Result Comparison for Taillard OSS}

\input{ossresultsummary}
\clearpage

\input{ossresultcompare}
