...
Table~\ref{tab:comparejss} compares the results for the Taillard job shop problems (incomplete). Only some of the problem groups are solved to optimality. For the 10/20 set, CPOptimizer proves optimality, while CPSat finds solutions which are very close to the optimal results. The bound results for 100/20 with CPSat are incorrect, and need to be recomputed.
