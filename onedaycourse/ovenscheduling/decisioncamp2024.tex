...
\title{\small Approximating a Global Objective by Solving
Repeated\\ Sub-problems for an Oven Scheduling
Problem} 
\date{DecisionCamp 2024, September 2024}
...
\includegraphics[width=.95\textwidth]{onepage}
\end{frame}
...
\end{itemize}
\includegraphics[width=7cm]{scheduling}
\end{column}
\begin{column}{0.5\textwidth}
\begin{itemize}
\item Car Sequencing
...
\end{itemize}
\includegraphics[width=7cm]{carseq}
\end{column}
\end{columns}
\end{frame}
...
\end{itemize}
\includegraphics[width=5.5cm,angle=180]{metagointago}
\end{column}
\end{columns}
\end{frame}
...
\begin{tabular}{cc}
\includegraphics[width=5cm]{../images/oven}
&
\includegraphics[width=7cm]{../images/compressor}
\\
...
\includegraphics[width=.9\textwidth]{wordcloud}
\end{column}
\end{columns}
\end{frame}
...
\includegraphics[width=.8\textwidth]{../images/jobgantt}
\end{frame}

\begin{frame}
\frametitle{Short Term Schedule: Resource View}
\includegraphics[width=.8\textwidth]{../images/ovengantt}
\end{frame}
...
\includegraphics[width=.8\textwidth]{../images/ovenschedule}
\end{frame}

\begin{frame}
\frametitle{Long Term Schedule: Abstracted Machine Runs}
\includegraphics[width=.8\textwidth]{../images/ovenruns}
\end{frame}
...
\includegraphics[width=.8\textwidth]{../images/lookahead}
\end{frame}

\begin{frame}
\frametitle{Impact of CommitHorizon Parameter}
\includegraphics[width=.8\textwidth]{../images/commithorizon}
\end{frame}

% \begin{frame}
% \frametitle{Comparing Different Solvers}
% \includegraphics[width=.8\textwidth]{../images/solvertype}
% \end{frame}
...
\begin{column}{0.5\textwidth}
\begin{itemize}
\item \href{https://modref.github.io/papers/ModRef2024_ApproximatingaGlobalObjectivebySolvingRepeatedSubproblems.pdf}{Paper on this problem (ModRef2024)} \qrcode[link,height=1.2cm]{https://modref.github.io/papers/ModRef2024_ApproximatingaGlobalObjectivebySolvingRepeatedSubproblems.pdf}
\item \href{https://arxiv.org/abs/2403.12717}{Overview of Teaching of Constraint Programming (Preprint)} \qrcode[link,height=1.2cm]{https://arxiv.org/abs/2403.12717}
\item \href{https://hsimonis.github.io/pthg24/}{Large survey on Constraint Programming and Scheduling (under development)} \qrcode[link,height=1.2cm]{https://hsimonis.github.io/pthg24/}
\end{itemize}

\end{column}
\begin{column}{0.5\textwidth}
From Survey: Nr of Works by Year
\includegraphics[width=\textwidth]{surveybyyear}
Sample: Works on Application Areas
\includegraphics[width=\textwidth]{applicationareas}
...
\includegraphics[width=.4\textwidth]{entirelogo}

\vspace{0.5cm}

\includegraphics[width=\textwidth]{entirepartners}

\vspace{0.5cm}

\includegraphics[width=.3\textwidth]{entirefunders}
\end{column}
\end{columns}
