...
\begin{frame}
\frametitle{Annotations on Features}
\begin{itemize}
\item \avail Currently available in scheduling tool
\item \soon Will be available shortly
\item \navail Currently not available, may be added in future version 
\end{itemize}
\end{frame}
...
\begin{frame}
\frametitle{The Most Common Relation: EndBeforeStart \avail}
\begin{columns}
...
\begin{frame}
\frametitle{Less Common: StartBeforeStart \avail}
\begin{columns}
\begin{column}{0.5\textwidth}
\begin{itemize}
...
\item Possible if one jobs produces multiple items (lots,...)
...
\begin{frame}
\frametitle{Start and End of Jobs \avail}
\begin{itemize}
...
\begin{frame}
\frametitle{Jobs: Release and Due Dates \avail}
\begin{columns}
\begin{column}{0.5\textwidth}
\begin{itemize}
...
\item Note that machines are still idle in optimal solution
\end{itemize}
...
\begin{frame}
\frametitle{Resource Constrained Project Scheduling Problem (RCPSP) \avail}
\begin{itemize}
...
\item Variants with alternative modes, process alternatives \navail
\end{itemize}
\end{frame}

\begin{frame}
\frametitle{RCPSP Process Diagram}
...
\begin{itemize}
\item The previous classes are good for algorithm research, but not very practical
...
\begin{frame}
\frametitle{Machine Gantt Chart \avail}
...
\begin{frame}
\frametitle{Job Gantt Chart \avail}
...
\begin{frame}
\frametitle{Cumulative Resource Chart \avail}
...
\begin{frame}
\frametitle{Resource Utilization \avail}
...
\begin{frame}
\frametitle{Intermediate Solutions \avail}
...
\begin{frame}
\frametitle{Process Diagram \avail}
\begin{columns}
\begin{column}{0.5\textwidth}
\begin{itemize}
...
\begin{frame}
\frametitle{PERT Chart(Program Evaluation Review Technique) \avail}
...
\begin{itemize}
\item Shows weekly structure for one or more years
\item Indicates public holidays, shut-downs, etc
\item Indicating working days, KPI for each day
\end{itemize}
