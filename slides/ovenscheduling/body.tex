...
\includegraphics[width=.95\textwidth]{images/onepage}
\end{frame}
...
\end{itemize}
\includegraphics[width=6cm]{images/scheduling}
\end{column}
\begin{column}{0.5\textwidth}
\begin{itemize}
\item Car Sequencing
...
\end{itemize}
\includegraphics[width=6cm]{images/carseq}
\end{column}
\end{columns}
\end{frame}
...
\end{itemize}
\includegraphics[width=4cm]{images/rfo}
\end{column}
\begin{column}{0.5\textwidth}
\begin{itemize}
...
\end{itemize}
\includegraphics[width=5.5cm,angle=180]{images/metagointago}
\end{column}
\end{columns}
\end{frame}
...
\begin{tabular}{cc}
\includegraphics[width=4cm]{images/oven}
&
\includegraphics[width=6cm]{images/compressor}
\\
...
\includegraphics[width=.9\textwidth]{images/wordcloud}
\end{column}
\end{columns}
\end{frame}
