...
\begin{itemize}
\item Our usual disjunctive resource model assumes that we can change easily from one task to the next
...
\item Due to the structure of the data, setup-time problems often are simpler to solve
\begin{itemize}
...
\item Example: dark-chocolate $\rightarrow$ milk chocolate $\rightarrow$ white chocolate $\rightarrow$ milk chocolate $\rightarrow$ dark chocolate
\end{itemize}
...
\item In some industries, this is the harder problem than scheduling the plant itself
\begin{itemize}
...
\item All your engineers are on service calls
\item \emph{Who you gonna call?}
\end{itemize}
