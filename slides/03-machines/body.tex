...
\end{itemize}
\item Considering multi-site, plants may be working in different time-zones
\begin{itemize}
\item Common example: data centres around the world, follow the moon
\end{itemize}
\end{itemize}
\end{frame}
...
\begin{itemize}
\item Which dates are expressed in working time, which in calendar time?
\item Examples
\begin{itemize}
\item Release/due dates typically expressed in calendar time
\item Task duration expressed in working time
\item Min/max waiting time expressed in calendar time
\end{itemize}
