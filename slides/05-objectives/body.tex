...
\item \emph{Makespan} if just reducing \emph{Total Lateness}
\end{itemize}
...
\item With enough answer, we can postulate a ranking method
\end{itemize}
\end{itemize}
\end{frame}
...
\end{itemize}
\item Other human scheduler want to modify the plan by hand
\begin{itemize}
